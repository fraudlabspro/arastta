<?php
class ModelAntifraudFraudLabsPro extends Model {
public function install() {
        ...
        $this->db->query("ALTER TABLE `" . DB_PREFIX . "order_fraudlabspro` CHANGE COLUMN `ip_address` `ip_address` VARCHAR(39) NOT NULL;");
        ...
        $this->db->query("INSERT INTO `" . DB_PREFIX . "setting` (`code`, `key`, `value`, `serialized`) VALUES ('fraudlabspro_antifraud', 'fraudlabspro_antifraud_score', '80', '0');");
        $this->db->query("INSERT INTO `" . DB_PREFIX . "setting` (`code`, `key`, `value`, `serialized`) VALUES ('fraudlabspro_antifraud', 'fraudlabspro_antifraud_order_status_id', '$status_fraud_id', '0');");
        $this->db->query("INSERT INTO `" . DB_PREFIX . "setting` (`code`, `key`, `value`, `serialized`) VALUES ('fraudlabspro_antifraud', 'fraudlabspro_antifraud_review_status_id', '$status_fraud_review_id', '0');");
        $this->db->query("INSERT INTO `" . DB_PREFIX . "setting` (`code`, `key`, `value`, `serialized`) VALUES ('fraudlabspro_antifraud', 'fraudlabspro_antifraud_approve_status_id', '2', '0');");
        $this->db->query("INSERT INTO `" . DB_PREFIX . "setting` (`code`, `key`, `value`, `serialized`) VALUES ('fraudlabspro_antifraud', 'fraudlabspro_antifraud_reject_status_id', '8', '0');");

        $this->cache->delete('order_status.' . (int)$this->config->get('config_language_id'));
    }

    public function uninstall() {
        //$this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "order_fraudlabspro`");
